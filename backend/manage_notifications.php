...
<body>
	...
	<div class="main-content">
		...
		echo "<table>";
		echo "<tr><th>ID</th><th>Title</th><th>Message</th><th>Action</th></tr>";
		while ($row = $result->fetch_assoc()) {
			echo "<tr>
                ...
                <td>{$row['message']}</td>
                <td>
                    <a href='edit_notification.php?id={$row['id']}'>Edit</a> |
                    <a href='delete_notification.php?id={$row['id']}'>Delete</a>
                </td>
            </tr>";
		}
		echo "</table>";
